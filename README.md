...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-13 12:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7c3be05c-9908-4d97-b373-8925d3bd9bec.git
$ cd 7c3be05c-9908-4d97-b373-8925d3bd9bec
```
